...
function EtiquetasTab() {
  ...
  const handlePrint = async () => {
    ...
    try {
      ...
      // HTML direto — sem canvas, sem conversão de imagem
      // 226px = 60mm a 96 DPI (DPI padrão CSS para impressão)
      const printHTML = `<!DOCTYPE html><html><head>
        <style>
          @page { size: 60mm 60mm; margin: 0; }
          * { box-sizing: border-box; }
          html, body { margin: 0; padding: 0; width: 226px; height: 226px; overflow: hidden; background: #fff; }
        </style>
